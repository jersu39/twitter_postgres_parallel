...
def insert_tweet(connection,tweet):
    ...
    with connection.begin() as trans:
        ...
        sql = sqlalchemy.sql.text('''
            insert into users
            (id_users, created_at, updated_at, id_urls, friends_count, listed_count, favourites_count, protected, verified, screen_name, name, location, description, withheld_in_countries)
            values (:id_users, :created_at, :updated_at, :id_urls, :friends_count, :listed_count, :favourites_count, :protected, :verified, :screen_name, :name, :location, :description, :withheld_in_countries)
            on conflict do nothing
            ''')
        res = connection.execute(sql, {
